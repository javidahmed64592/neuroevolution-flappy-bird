"""Pipe object for Flappy Bird game."""
...
class Pipe:
    ...
    def __init__(self, x_lim: int, y_lim: int, speed: float) -> None:
        ...
        :param float speed: Pipe movement speed
        """
        self._x: float = x_lim
    ...
    def rects(self) -> list[pygame.Rect]:
        """Get Pipe's rectangles for collision detection."""
    ...
    def normalised_speed(self) -> float:
        """Get normalised speed of Pipe."""
        return self._speed / Pipe.MAX_SPEED

    def draw(self, screen: pygame.Surface) -> None:
        """Draw Pipe on the display.

        :param pygame.Surface screen: Screen to draw Pipe to
        """
        if self.offscreen:
            return
    ...
    def get_speed(pipes_spawned: int) -> float:
        ...
        :param int pipes_spawned: Number of Pipes spawned in current generation
        :return float: Pipe speed
        """
    ...
    def get_spawn_time(pipes_spawned: int) -> float:
        ...
        :param int pipes_spawned: Number of Pipes spawned in current generation
        :return float: Time until Pipe spawns
        """
